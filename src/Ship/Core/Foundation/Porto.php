...
class Porto
{
    ...
    private const SHIP_NAME = 'src/Ship';

    private const CONTAINERS_DIRECTORY_NAME = 'src/Containers';
    ...
    {
        return File::directories(base_path(self::SHIP_NAME));
    }
    ...
    {
        return base_path(self::CONTAINERS_DIRECTORY_NAME.DIRECTORY_SEPARATOR.$sectionName);
    }
    ...
    {
        return File::directories(base_path(self::CONTAINERS_DIRECTORY_NAME));
    }

    public function getSectionContainerPaths(string $sectionName): array
    {
        return File::directories(base_path(self::CONTAINERS_DIRECTORY_NAME.DIRECTORY_SEPARATOR.$sectionName));
    }
}
