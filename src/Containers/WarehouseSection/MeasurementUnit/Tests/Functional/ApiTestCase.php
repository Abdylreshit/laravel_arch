...
namespace App\Containers\WarehouseSection\MeasurementUnit\Tests\Functional;
...
class ApiTestCase extends TestCase
{
    protected function getStaffToken(): string
    {
        ...
        app(StaffPermissionManager::class)->syncContainerPermissionsToStaff($staff, 'MeasurementUnit');
